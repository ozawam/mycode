...
//    double total_disk_mass = 15.0*M_earth/M_sun;
    int N_planetesimals = 400;
    double rho_planet = _rho_planet * 1.49597871e13 * 1.49597871e13 * 1.49597871e13 / 1.9884e33; // [Msun/AU^3]
    double planetesimal_mass = 5.0e+24/M_sun;//total_disk_mass/N_planetesimals;//M_sun //unit:Msun;
...
//    double amin = acenter - delta_a/2.0 , amax = acenter + delta_a/2.0 ;
    double rH = pow(2.0*planetesimal_mass/star.m ,1.0/3.0) * acenter ;
    double h = rH/acenter ;
    double delta_a =0.3 * rH;
