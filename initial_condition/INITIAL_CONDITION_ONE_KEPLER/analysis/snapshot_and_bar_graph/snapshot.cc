...
coina >> after[0] >> after[1] >>  after[2] >> after[3] >> after[4] >> after[5] >> after[6] >> after[7] >> after[8] >> after[9] >> after[10] >> after[11] >>  after[12] >> after[13] >> after[14] >> after[15] >> after[16] >> after[17] >> after[18] >> after[19] >> after[20] >> after[21] >>  after[22] >> after[23] >> determination;


coaout << after[0]  << " " << after[6] << " " << after[7] << " " << after[16] << " " << after[17] <<'\n';
...
//	  cout <<" mean_mass  = " << mean_mass  << '\n'; 
	  mout << first_line[0]  << "  " << max << "  " << mean_mass  << "  " << second  << "  " << resonance_angle  << "  " <<  n   << "  " << Npp  <<'\n';//g
